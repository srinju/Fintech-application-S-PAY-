...
export default  function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error occurred during signup:', errorMsg); 
      ...
      <header className='flex flex-col gap-5 md:gap-8'>
        <Link href="/" className='cursor-pointer flex items-center gap-1'>
          <Image
            ...
            alt='company Logo'
          />
          <h1 className='text-26 font-bold text-black-1'>SPay</h1>
        </Link>
        ...
        <div className='flex flex-col gap-1 md:gap-3'>
          <h1 className='text-24 lg:text-36 font-semibold text-gray-900'>
            {user
              ? 'Link Account'
              : 'Not a user, please provide valid credentials'
            }
          </h1>
      ...
      {user ? (
        ...
        <div className="max-w-md mx-auto mt-10 p-5 border rounded-lg shadow-lg">
            ...
            <div className="flex space-x-4">
              ...
              <div className="flex-1">
                ...
                <input
                  type="text"
                  name="state"
                  value={formData.state}   // Adding the state input field
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 text-slate-950 rounded"
                  placeholder="ex: NY"
                  required
          ...
          <p className="text-center mt-4">
            Already have an account? <Link href="/api/auth/signin" className="text-blue-500">Login</Link>
          </p>
        </div>
      )}
    </section>
